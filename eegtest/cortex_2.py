...
class Cortex(models.Field):

    def __init__(self, user, client_secret, client_id, url, ws, *args, **kwargs):
        ...
        self.url = None
        self.ws = None
        super(Cortex, self).__init__(user, client_secret, client_id, url, ws, *args, **kwargs)

    def to_python(self, value):
        if isinstance(value, Cortex):
            return value
